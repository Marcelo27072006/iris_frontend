  ...
  Future<void> _deleteAccount(BuildContext context) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 204) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Erro ao deletar conta: ${response.statusCode}")),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 30),
                      const Divider(thickness: 1, color: Color(0xFFD893E3), height: 40),
                      ...
                      const InfoContainer(icon: Icons.favorite, label: 'Nome do(a) cônjuge'),
