...
//       body: Stack(
//         children: [
//           // Fundo com manchas roxas suaves
//           Positioned.fill(
//             child: Container(
...
//                       circleColor: rankingList[1]['color'],
//                       size: 70,
//                       medalSize: 20,
...
//                       circleColor: rankingList[0]['color'],
//                       size: 100,
//                       medalSize: 30,
...
//                       circleColor: rankingList[2]['color'],
//                       size: 70,
//                       medalSize: 20,
  ...
  Future<void> fetchRanking() async {
    try {
      final response = await http.get(
        Uri.parse('http://192.168.100.112:3000/ranking'),
